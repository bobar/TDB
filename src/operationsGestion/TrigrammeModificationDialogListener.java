...
public class TrigrammeModificationDialogListener implements KeyListener, ActionListener {
	...
	private TrigrammeModificationDialog parent;

	public TrigrammeModificationDialogListener(TrigrammeModificationDialog dialog) {
		super();
		this.parent = dialog;
	}
	...
	public void keyReleased(KeyEvent arg0) {
		if (arg0.getSource().equals(parent.champTrigramme)) {
			...
			if (parent.champTrigramme.getText().length() < 3) {
				...
				if (parent.champTrigramme.getText().equals(parent.parent.trigrammeActif.trigramme)) {
					parent.validation = true;
