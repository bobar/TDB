...
public class TrigrammeCreationDialog extends JDialog {
	...
	MainWindow parent;
	TrigrammeCreationDialogListener listener = new TrigrammeCreationDialogListener(this);
	...
	public void executer() throws Exception {
		...
		if (authentification.droits == AuthentificationDialog.BoBarman) {
			...
			if (validation) {
				Trigramme trigramme = new Trigramme(parent, champTrigramme.getText(), nom, prenom,
						surnom, champCasert.getText(), champCategorie.getSelectedIndex(),
