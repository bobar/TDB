    ...
    public void actionPerformed(ActionEvent arg0) {
      try {
        if (arg0.getSource().equals(creerButton)) {
          ...
          if (Droits.droitsUtilises(parent, (String) listeDroits.getValueAt(ligneChoisie, 0))) {
            confirmation =
                JOptionPane.showConfirmDialog(parent,
                    "Les droits " + listeDroits.getValueAt(ligneChoisie, 0)
          ...
          if (confirmation == JOptionPane.OK_OPTION) {
            Droits droits = new Droits(parent, (String) listeDroits.getValueAt(ligneChoisie, 0));
            DroitsModificationDialog dialog = new DroitsModificationDialog(parent, droits);
            dialog.executer();
          }
          ...
          int confirmation =
              JOptionPane.showConfirmDialog(
                  ...
                  "Etes-vous sur de vouloir supprimer les droits "
                      + listeDroits.getValueAt(ligneChoisie, 0), "Confirmation",
