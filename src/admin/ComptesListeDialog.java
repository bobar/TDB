  ...
  public class ComptesListeDialogListener implements ActionListener, KeyListener {
    ...
    public void actionPerformed(ActionEvent arg0) {
      if (arg0.getSource() == fermerButton) {
        ...
        int confirmation =
            JOptionPane.showConfirmDialog(parent, "Etes-vous sur de vouloir envoyer les mails ?",
        ...
        if (confirmation == JOptionPane.YES_OPTION) {
          try {
            ...
            for (int i = 0; i < nbLignes; ++i) {
              Trigramme trig = new Trigramme(parent, (String) modele.getValueAt(i, 0));
              trig.sendPolytechniqueMail();
            }
            JOptionPane.showMessageDialog(parent, nbLignes + " mails envoyés.", "Mails envoyés",
