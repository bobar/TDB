      ...
      try {
        if (arg0.getSource().equals(creerButton)) {
          ...
          AdminModificationDialog dialog =
              new AdminModificationDialog(parent, (String) listeAdmin.getValueAt(ligneChoisie, 0),
                  permissions);
          dialog.executer();
          ...
          int confirmation =
              JOptionPane.showConfirmDialog(parent, "Etes-vous sur de vouloir supprimer "
          ...
          if (confirmation == JOptionPane.OK_OPTION) {
            Admin admin = new Admin(parent, (String) listeAdmin.getValueAt(ligneChoisie, 0));
            admin.supprimer();
          }
