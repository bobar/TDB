...
public class Historique {
	...
	public static LinkedList<Entry> getHistorique(MainWindow parent,
			Trigramme trigramme, int limit) throws Exception {
		Statement stmt = parent.connexion.createStatement();
		String query = "SELECT price as p,comment as c, ac1.trigramme as t1,ac2.trigramme as t2,ac3.trigramme as t3,date "
				...
				+ " WHERE tr.id=" + trigramme.id + " ORDER BY date DESC";
		if (limit >= 0)
			query += " LIMIT " + limit;
		...
		while (rs.next()) {
			...
			zou.date = rs.getString("date").substring(0,
	...
	public static LinkedList<Entry> getOldHistorique(MainWindow parent,
			Trigramme trigramme, int limit) throws Exception {
		Statement stmt = parent.connexion.createStatement();
		String query = "SELECT price as p,comment as c, ac1.trigramme as t1,ac2.trigramme as t2,ac3.trigramme as t3,date "
